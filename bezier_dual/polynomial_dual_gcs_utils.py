...
def define_sos_constraint_over_polyhedron(prog:MathematicalProgram,
    ...
    return lambda_0, lambda_1_left, lambda_1_right, lambda_2_left, lambda_2_right, lambda_2_left_right
