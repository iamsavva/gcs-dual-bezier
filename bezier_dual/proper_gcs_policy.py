...
def get_all_n_step_paths(graph: PolynomialDualGCS, start_lookahead:int, start_vertex: DualVertex)->T.List[T.List[DualVertex]]:
    """
...
def solve_convex_restriction(graph: PolynomialDualGCS, path: T.List[DualVertex], state_now: npt.NDArray, state_last:npt.NDArray=None, options:ProgramOptions = None)->T.Tuple[float, T.List[T.List[npt.NDArray]]]:
    """
